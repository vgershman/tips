...
public class CategoryActivity extends SherlockFragmentActivity {
	...
	private void share() {
		...
		share.putExtra(Intent.EXTRA_TEXT, getString(R.string.tip_tag) + "\n" + tip2Share.getText() + "\n" + tip2Share.getTextItalic());
		//share.putExtra(Intent.EXTRA_STREAM, Uri.parse(DailyTipsApp.HOSTING_BASE_URL + "/" + tip2Share.getCategoryName().toLowerCase() + "/" + tip2Share.getId() + ".jpg"));
		Intent chooserIntent = Intent.createChooser(share, getString(R.string.share_select_ac));
